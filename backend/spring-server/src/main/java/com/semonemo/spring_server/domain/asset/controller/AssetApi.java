...
//
//
// 	CommonResponse <AssetResponseDto>  getAssetDetail(@PathVariable Long assetId) ;
//
// 	CommonResponse <AssetSellResponseDto>  getAssetSellDetail(@PathVariable Long assetSellId);
//
// 	CommonResponse<CursorResult<AssetSellResponseDto>> getAllAsset(
// 		@AuthenticationPrincipal UserDetails userDetails,
// 		@RequestParam(required = false) Long cursorId,
